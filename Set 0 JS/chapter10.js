...
// var answer1 = myLib.math.real.mul(2,5);
// var answer2 = myLib.math.real.add(20, 22);
// var answer = myLib.math.real.sub(answer2,answer1);   
// console.log(answer);    
...
//            );
  ...
  // This is simplified expresion with NO "with statements"   
  // var ans1 = new myLib.math.complex.Num (3,4);
  // var ans2 = myLib.math.real.add(5,2)
  // var ans3 = new myLib.math.complex.Num(ans2,-3);
  // var ans4 = myLib.math.complex.sub(ans3,ans1);
  // var ans5 = myLib.math.matrix.eye (4);
  // var ans = myLib.math.matrix.times (ans5,ans4);   //  This line doesn't work due to the las operation 
  //                                                  //must have as arguments 2 matrices of the same size.     
  // console.log(ans); 
  //****************************************************************
